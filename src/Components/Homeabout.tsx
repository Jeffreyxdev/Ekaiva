...
const Homeabout = () => {
  return (
    <section
      id="about"
      className="relative py-20 bg-[#f6f8f7] overflow-hidden"
    >
      <div className="max-w-8xl mx-auto px-26">
        {/* Top bar */}
        <div className="flex flex-wrap justify-between items-center mb-16">
          <button className="px-5 py-1.5 border border-gray-300 rounded-full text-sm text-gray-700 hover:bg-gray-100 transition-colors">
            02. About
          </button>
        ...
        <div className="grid lg:grid-cols-3 gap-12 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-medium text-gray-900 leading-tight mb-6 font-montserrat monst">
          ...
          >
            ...
            <div className="absolute w-[290px] h-[370px] bg-[#3D443B]/40 rounded-3xl rotate-20 top-6"></div>
            <div className="absolute w-[290px] h-[370px] bg-[#3D443B]/40 rounded-3xl rotate-26 top-10"></div>
            
            <div className="absolute w-[300px] h-[370px] bg-[#3D443B]/40 rounded-3xl rotate-9 top-7"></div>
            ...
            {/* Main image card */}
            <div className="relative bg-white rounded-3xl shadow-lg w-[300px] p-4 z-10">
              <img
                src={image}
          ...
          <motion.div
            ...
            className="lg:pl-4"
          >
            <h3 className="text-xl md:text-xl font-semibold mb-4 monst">
              No neighbors, calls or fuss
            </h3>
            <p className="text-gray-600 leading-relaxed mb-6 monst">
