      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 lg:pr-8">
            ...
            From Dunes to Skylines — The Ultimate UAE Escape

            </h1>

            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
            tep into a land of contrasts where desert sands meet futuristic skylines. Experience the magic of Dubai’s glittering city life and the elegance of Abu Dhabi’s royal charm. Cruise through Dubai Marina, feel the thrill of desert safaris, ascend the Burj Khalifa, and end with the adrenaline of Ferrari World. <br />
 Every day is a story  from golden sunsets to red Ferraris, all wrapped in Arabian luxury.
          ...
          >
            <div className="relative aspect-[3/4.5] overflow-hidden">
              <img
                src='https://images.unsplash.com/photo-1650826123559-cc1dad9c42a3?'
