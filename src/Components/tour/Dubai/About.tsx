      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 lg:pr-8">
            ...
            An Arabian Adventure Through Luxury and Heritage
            </h1>

            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
             Immerse yourself in the beauty of Dubai, a city that blends ancient traditions with modern marvels. Explore record-breaking landmarks, serene beaches, bustling souks, and endless desert horizons. From the breathtaking Burj Khalifa views to the tranquility of the Arabian sands, this journey reveals every shade of Dubai’s charm.
            </p>
            ...
            >
              <div className="relative aspect-[4/2.7] overflow-hidden">
                <img
                  src='https://images.unsplash.com/photo-1628859017536-c2f1d69f3c84'
                  loading='lazy'
