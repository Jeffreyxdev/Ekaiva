...
const Hero = () => {
  ...
  <img
    src='https://images.unsplash.com/photo-1628859017536-c2f1d69f3c84?auto=compress'
    alt="Background"
   fetchPriority="high"
    loading="lazy"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-end pb-20">
        <div className="text-white max-w-2xl">
         ...
         Dubai Discovery
          ...
          >
           Experience the glamour, culture, and adventure of Dubai — where golden deserts meet futuristic skylines.
          ...
          ><a href="https://wa.me/917011020040?text=Hi%20Ekaiva,%20I'm%20interested%20in%20Dubai%20booking%20for%20___days.">
            Book Now</a>
          </motion.button>
        </div>
      </div>
