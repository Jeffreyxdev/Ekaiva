    ...
    <div className="min-h-screen bg-white p-6 md:p-12 lg:p-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 md:mb-16">
          <button
            className="px-6 py-2 mb-8  rounded-full text-gray-700 text-sm font-medium tracking-wide transition-all duration-300 hover:border-gray-400 hover:bg-gray-50 hover:-translate-y-1 hover:shadow-2xl"
          >
            02. About
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 lg:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-gray-900 leading-tight mont">
             Welcome to Your Sunrise Taj Mahal adventure
            </h1>
