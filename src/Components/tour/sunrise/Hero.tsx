  ...
  />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-end pb-20">
        <div className="text-white max-w-2xl">
          ...
          >
          Experience the magic of the Taj Mahal at dawn with Ekaiva’s private car tour from Delhi. Enjoy exclusive access, a knowledgeable guide, and visits to iconic Agra sites in a seamless one-day itinerary designed for comfort and wonder.
          ...
          ><a href="https://wa.me/917011020040?text=Hi%20Ekaiva,%20I'm%20interested%20in%20taj%20mahal%20booking%20a%20from%20Dehli">
            Book Now</a>
          </motion.button>
        </div>
      </div>
