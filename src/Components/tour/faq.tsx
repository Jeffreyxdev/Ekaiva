...
function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'All major attractions and experiences are covered, including castle entries and brewery tours.',
    ...
    },
    {
      ...
      answer: 'Insurance is recommended but not included; advice is available.',
