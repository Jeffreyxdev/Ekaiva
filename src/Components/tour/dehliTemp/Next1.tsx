        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 lg:pr-8">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
             Step beyond city chaos and discover Delhi’s sacred heart on this spiritual journey. From the powerful chants at Jama Masjid to the serenity of Gurudwara Bangla Sahib, and the awe-inspiring architecture of Akshardham and Lotus Temple—you’ll witness the city’s diversity and feel genuine calm.
