...
export default function Rajabout() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 lg:pr-8">
            ...
            A Journey Through Majesty and Tradition
            </h1>

            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
             Discover the grandeur of India’s historical heartland over 13 unforgettable days. From the bustling bazaars of Delhi to the golden sands of Jaisalmer, sparkling lakes of Udaipur, and vibrant streets of Jaipur and Jodhpur, this tour blends deep history, architectural wonders, and colorful culture. Travel comfortably with private transfers and expert guides, savor local flavors, and build memories to last a lifetime.
