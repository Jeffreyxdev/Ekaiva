...
const Hero = () => {
  ...
  <img
    src='https://images.unsplash.com/photo-1509384658642-3f88b1291b3d?auto=compress'
    alt="Background"
   fetchPriority="high"
    decoding="async"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-end pb-20">
        <div className="text-white max-w-2xl">
         ...
         Ireland – Scotland- 11days
          ...
          >
           Explore the rich culture, history, and scenic landscapes of the British Isles on a private coach tour designed for groups of 20+.
          ...
          ><a href="https://wa.me/917011020040?text=Hi%20Ekaiva,%20I'm%20interested%20in%20%20booking%20for%20___days.">
            Book Now</a>
          </motion.button>
        </div>
      </div>
