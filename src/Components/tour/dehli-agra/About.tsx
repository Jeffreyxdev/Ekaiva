        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 lg:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-gray-900 leading-tight mont">
             The Soul of India in One Journey
            </h1>

            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              Experience India’s most iconic circuit—Delhi, Agra, Jaipur, and Varanasi—on this 8-day immersive tour that blends history, architecture, and spirituality. From the timeless Taj Mahal to Jaipur’s royal forts, and the sacred ghats of Varanasi, every stop reveals a new shade of India’s cultural spirit. Let each city’s stories unfold as you travel with expert guides, private comfort, and unforgettable moments by the Ganges.
          ...
          >
            <div className="relative aspect-[3/4.2] overflow-hidden">
              <img
                src='https://images.unsplash.com/photo-1557690756-62754e561982?q=80&w=619&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
