...
const Hero = () => {
  ...
  <img
    src='https://images.unsplash.com/photo-1736568763844-2063f7761462?auto=compress'
    alt="Background"
   fetchPriority="high"
    decoding="async"
  ...
  />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-end pb-20">
        ...
        Delhi → Agra → Jaipur→
          ...
          >
           From the Mughal marvels of Delhi and Agra to Jaipur’s royal aura and Varanasi’s eternal spirituality, this journey takes you across India’s most iconic landscapes and sacred stories.
          ...
          ><a href="https://wa.me/917011020040?text=Hi%20Ekaiva,%20I'm%20interested%20in%20Dehli%20to%20agra%20to%20japuir%20to%20varanasi%20booking%20details">
            Book Now</a>
          </motion.button>
        </div>
      </div>
