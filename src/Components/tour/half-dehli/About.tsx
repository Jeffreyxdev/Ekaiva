        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 lg:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-gray-900 leading-tight mont">
             Welcome to Delhi’s Untold Sights
            </h1>

            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
             Explore Delhi at your pace with a tour designed for time-conscious travelers. Whether you opt for Old Delhi’s bustling streets or New Delhi’s majestic avenues, this experience offers a blend of history, authenticity, and urban vibrance.
                Our expert guides speak your language, ensuring every story comes alive as you move from ancient mosques to modern marvels. Tailor your route, travel in private 
