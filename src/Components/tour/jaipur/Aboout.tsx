        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 lg:pr-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-gray-900 leading-tight mont">
             A Cultural Odyssey Through Northern India
            </h1>

            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
             Embark on a 10-day journey through Rajasthan’s majestic forts, palaces, and serene lakes. Beginning in Delhi, experience the dynamic blend of Old and New Delhi’s heritage sites. Witness the iconic Taj Mahal﻿ in Agra, explore Jaipur’s pink city charm, feel the sun-kissed grandeur of Jodhpur, and unwind by Udaipur’s tranquil lakes. With handpicked accommodations and expert guides, this tour brings India’s rich past vividly to life.
            </p>
