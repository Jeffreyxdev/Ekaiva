...
export default function Europeabout() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          <div className="space-y-6 lg:pr-8">
            ...
            A Grand Journey Through Europe’s Classics
            </h1>

            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
             Soak in London’s energy, marvel at royal castles, shop exclusive outlets, and tour football shrines. Ride historic boats and trains through Lake District scenery, then uncover Scottish charm from Edinburgh’s castles to Loch Ness and the highlands. Each day blends culture, city life, and countryside beauty for an unforgettable all-in coach journey.
            </p>
            ...
            >
              <div className="relative aspect-[4/2.7] overflow-hidden">
                <img
                  src='https://images.unsplash.com/photo-1544213255-6c4437bb6308'
                  loading='lazy'
          ...
          >
            <div className="relative aspect-[3/4.2] overflow-hidden">
              <img
                src='https://images.unsplash.com/photo-1594800083755-8fe31b2c99df'
