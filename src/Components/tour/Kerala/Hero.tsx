...
const Hero = () => {
  ...
  <img
    src='https://images.unsplash.com/photo-1580818135730-ebd11086660b?auto=compress'
    alt="Background"
   fetchPriority="high"
    decoding="async"
  ...
  />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-end pb-20">
        <div className="text-white max-w-2xl">
          ...
          >
          Kerala Bliss – 10 Days 


            <br />
           of Tranquility & Tradition
          ...
          >
           Discover God’s Own Country through misty hills, serene backwaters, golden beaches, and timeless culture.
          ...
          ><a href="https://wa.me/917011020040?text=Hi%20Ekaiva,%20I'm%20interested%20in%20Kerala20booking%20for%20___days.">
            Book Now</a>
          </motion.button>
        </div>
      </div>
