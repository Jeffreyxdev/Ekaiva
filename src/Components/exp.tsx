  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
    ...
    <div className="flex items-start lg:justify-end">
      <p className="text-gray-600 max-w-xl leading-relaxed lg:text-right lg:mt-20">
        Take a peek at real photos from Ekaiva travelers  smiling families, happy solo guests,
        and exotic locations all enjoyed at budget prices. Our gallery highlights authentic
        Indian experiences, MICE events, and international tours made memorable by value and care.
      </p>
    </div>
  </div>
